...
<!-- 傳姪判斷是否為生命週期改變之企業，如企業處於改變狀態，則顯示萌芽期、成長期、成熟期-->
 ...
 @if (session('bsc'))
  ...
  <div>
    <button type="button" class="btn btn-primary" id="Qbtn" value="next" onclick="location.href='/GrowthStrategy/Q3'" style="width:100px; margin-top: 20px; float: right;">下一步驟</button>
  </div>
  @else
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header" style="background: #2471A3 ;color: white">
       ...
       <form class="needs-validation" method="POST" action="/GrowthStrategy/Q2" novalidate>
          {{csrf_field()}} 
