...
<div>
    ...
    <div class="row" style="margin-bottom: 200px">
        ...
        <div style="padding: 0 50px">@include('importdata.Upperlimit')</div>
            <div class="justify-content-end">
            <button type="button" class="btn btn-secondary" id="Qbtn" value="上一題" onclick="location.href='/Allocation/Q11/strategy'" style="width:100px; margin-top: 20px; margin-right: 5px; float: right;">上一題</button>
             </div>
        </div>
        </div>
        @endif
        ...
        <div style="padding: 0 50px">@include('importdata.Lowerlimit')</div>
            <div class="justify-content-end">
            <button type="button" class="btn btn-secondary" id="Qbtn" value="上一題" onclick="location.href='/Allocation/Q12/strategy'" style="width:100px; margin-top: 20px; margin-right: 5px; float: right;">上一題</button>
             </div>
        </div>
        </div>
        @endif
        ...
        <p class="lead" style="margin-bottom: 50px">資源能耐分配策略模式</p>
        <div style="padding: 0 10px">顯示分析結果</div>
        
            <div class="justify-content-end">
            <button type="button" class="btn btn-secondary" id="Qbtn" value="next" onclick="location.href='/Allocation/Q15/strategy'" style="width:100px; margin-top: 20px; float: right;">next</button>
            <button type="button" class="btn btn-secondary" id="Qbtn" value="上一題" onclick="location.href='/Allocation/Q13/strategy'" style="width:100px; margin-top: 20px; margin-right: 5px; float: right;">上一題</button>
             </div>
        </div>
        </div>
        @endif
